...
function updateBanner() {
  ...
  document.getElementById('info-banner-bg').style.height =
    document.getElementById('info-text').clientHeight + 24 + 2 + 'px';
}
...
function typeMessage(lastIndex) {
  ...
  let typeLetter = function (i) {
    var keypressTime = Math.floor(
      MIN_KEYPRESS_TIME +
        Math.random() * (MAX_KEYPRESS_TIME - MIN_KEYPRESS_TIME)
    );
